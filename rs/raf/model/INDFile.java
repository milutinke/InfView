...
public class INDFile extends UIAbstractFile {
...
/*	public INDFile(String path,String headerName, boolean directory) {
	...
	public INDFile(String name, String location, String file) {
	...
	public int[] findRecord(ArrayList<String> searchRec,Boolean all,Boolean fromStart) {
		...
		String[][] dataFounded=new String[(int) (FILE_SIZE/94)][fields.size()];
		...
		while(FILE_POINTER<FILE_SIZE) {
			...
			for(int red=0;red<data.length;red++) {
				...
				else if(isRowGreater(data[red], searchRec)){
					stopSearch=true;
					break;
				}
	...
	//	fireUpdateBlockPerformed();
		...
		n = JOptionPane.showConfirmDialog(
                null, "Would you like to save results?",
                "Optional",
